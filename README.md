...
这是一个完整的电子锁控制系统，包含Linux桌面应用、Android应用以及ESP32微控制器等。该系统允许通过多种方式远程控制电子锁的开关。此项目不使用英文介绍，因为此项目仅针对中国青少年使用：如果您的父母尊重你的隐私，你无需此项目。如果您的父母不尊重您的隐私，我相信以他们的能力看不懂此项目，您可以放心安全性问题。
...
ESP32的A0引脚连接到PWM控制MOS模块的IO引脚，供电请自行连接。
